...
def extract_emails(html):
    ...
    blocked_domains = {"example.com", "domain.com", "yourdomain.com", "email.com", "work.com", "yourcompany.com", "temp.com", "acmecorp.com", "studio.com", "test.com", "mycompany.com", "uneed.best"}
